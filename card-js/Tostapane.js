/* frarik-version: 2.7 */
/* v2.5: popup Energia/Cicli/Impostazioni allineati allo standard delle altre
...
/* v2.7: popup Impostazioni ora a due colonne pari (impostazioni a sinistra,
...
(function () {
  ...
  function openCicliPopup(c) {
    ...
    mkOv(popShell('🍞', 'Cicli & Statistiche', 'fc-ci-close', content), 'fc-ci-close');
  }
  ...
  function openCfg(card, el) {
    ...
    const ov = mkOv(popShell('🍞', 'Configura Tostapane', 'fc-cfg-close', formHtml), 'fc-cfg-close');
  ...
  function mount(card, hass, el) {
    ...
    el._fcHandler = function (e) {
      ...
      if (a === 'popup-impostazioni') { openImpostazioniHAPopup(card, cfgFor(card)); return; }
    };
...
`;
  ...
  /* ── CARD REGISTRATION ── */
  const CARD = {
    id: 'tostapane', name: 'Tostapane', icon: '🍞', version: '2.7',
