...
(function () {
  ...
  function openImpostazioniHAPopup(c) {
    ...
    const ov = mkOv(popShell('⚙', '100,116,139', 'Impostazioni', S(h, 'input_text.frarik_lavatrice_nome') || c.name || 'Lavatrice', closeId, swCss + rows.join('') + saveBtn + resetBtn), closeId);
