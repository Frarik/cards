...
(function () {
  ...
  function openCicliPopup(c) {
    ...
    DAYS.forEach(function (d, i) {
      const cicli = cleanVal(S(h, 'input_text.' + d + '_asciugatrice_cicli'));
      const tempo = cleanVal(S(h, 'input_text.' + d + '_asciugatrice_tempo'));
...
- alias: asciugatrice_off_automatico
  ...
  /* ── CARD ── */
  const CARD = {
    id: 'asciugatrice', name: 'Asciugatrice', icon: '💨', version: '1.1',
