/* frarik-version: 3.0 */
/**
 * GruppoFinestre.js — Distintivo FratechStore v3.0
 * v3.0: popup config — riquadro unico (Chip/Entità/Aggiungi) con contorno
 ...
 * v2.5: fix — il riquadro chiuso restava neutro/bianco invece di verde (il colore veniva
 *       applicato solo allo stato aperto); ora sempre colorato (verde chiusa, rosso
 *       aperta). Uniformata la dimensione dei testi a quella di GruppoLuci (nome tile
 *       14.5px, stato tile 10.5px).
 * v2.6: tile stessa altezza di GruppoLuci/Allarme (icona finestra in box fisso 44px,
...
(function () {
  ...
  try { console.log('[FratechStore] Distintivo registrato: gruppo-finestre v3.0'); } catch(e){}
})();
