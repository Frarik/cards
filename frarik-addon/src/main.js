...
/* ═══════════════════════════════════════════════════════════════
   POSTA-CARD  —  Centro Controllo Posta  v1.0
   ═══════════════════════════════════════════════════════════════ */
(function _definePostaCard(){
  ...
  function _svgBox(state){ // 'none'|'mail'|'open'
    ...
    _renderNotInstalled(){
      ...
      <div class="wrap">
        ...
        <div class="body ni-body">
          ...
          <button class="ni-btn" data-a="how-to">📋 Come installare</button>
        </div>
      </div>`;
    }
      ...
      host.shadowRoot.innerHTML=`
        ...
        <div class="ov" data-a="close-modal">
          <div class="mo" onclick="event.stopPropagation()">
            <div class="mhdr">
              <div class="mico">📦</div>
              <div class="mtit">Installazione Package Posta</div>
              <button class="mxbtn" data-a="close-modal">✕</button>
            </div>
            <div class="mbody">
              <div class="step">
                <span class="step-n">PASSO 1</span>
                <p>Scarica il file <strong>posta.yaml</strong> dalla pagina GitHub di Frarik e copialo nella cartella <code>/config/packages/</code> del tuo Home Assistant (usa File Editor o Studio Code Server).</p>
              </div>
              <div class="step">
  ...
  packages: !include_dir_named packages</code>
                <p style="margin-top:8px;opacity:.6;font-size:12px">Se la cartella "packages" non esiste, creala manualmente in /config/</p>
              </div>
              <div class="step">
                <span class="step-n">PASSO 3</span>
                <p>Apri <strong>posta.yaml</strong> e sostituisci i segnaposto con le tue entità:</p>
...
IL_TUO_MOBILE_APP_1</code>
              ...
              <div class="step">
                <span class="step-n">PASSO 4</span>
...
/* not installed */
.ni-body{display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;gap:12px;padding:30px 20px}
.ni-icon{font-size:52px;line-height:1}
.ni-title{font-size:17px;font-weight:900;color:#fff}
.ni-sub{font-size:13px;color:#fff;opacity:.55;line-height:1.7}
.ni-btn{padding:13px 24px;border-radius:13px;background:rgba(99,102,241,.25);border:1px solid rgba(99,102,241,.45);color:#a5b4fc;font-size:13px;font-weight:800;cursor:pointer;font-family:system-ui,sans-serif;transition:all .15s}
.ni-btn:active{background:rgba(99,102,241,.4)}
`; }
  }

  customElements.define('posta-card', PostaCard);
  _registerLovelaceCard('posta-card',{
