...
|---|---|---|---|---|---|
| card-js | `Antizanzare.js` | `antizanzare-card` | Anti Zanzare | 1.4 | Lovelace |
...
| card-js | `person-card.js` | `person-card` | 👤 Persona | 1.13 | FratechStore |

## Dettaglio

### Anti Zanzare  ·  `Antizanzare.js`
- **ID:** `antizanzare-card` · **versione:** 1.4 · **formato:** Lovelace
...
- **ID:** `person-card` · **versione:** 1.13 · **formato:** FratechStore
